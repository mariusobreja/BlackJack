    ...
    function playend() {
        ...
        //if(this.dealerBlackjack===1){
          //  message.innerHTML = "Dealer Blackjack";
        //  }
        ...
        if(mypounds<=0){
        document.getElementById('btndeal').style.display = 'none';
        message.innerHTML += " - You are out of money. Press restart game to start another game. "+"<a href=''>Restart game.</a>";
    }
    }
